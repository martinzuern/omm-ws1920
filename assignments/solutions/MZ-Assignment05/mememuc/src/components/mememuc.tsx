...
const OmmMemeMUC: React.FC = () => {
  ...
  return (<div className="mememuc">
    ...
    <div className="params">
      ...
      <input type="button" value="Save to favorites" className="save-fav" onClick={() => selectState && url && setSavedMemes([...(savedMemes || []), { baseMeme: selectState, caption: captionState, link: url }])}></input>
    </div>
    <OmmMemeMUCHistory 
      savedMemes={savedMemes!} 
      onDeleteMeme={(idx:number) => {
        setSavedMemes((savedMemes || []).filter((_, i) => i !== idx))}
      }
      />
  </div>);
};
